...
export default function SideNav() {
  return (
    <div className="w-1/4 min-h-screen font-poppins  px-4 pt-8 bg-blue-600 text-white flex flex-col">
      ...
      <Link href="/">
  <button
    className="flex items-center pl-4 pr-4 py-2 mt-2 rounded-lg group hover:bg-[#F3F5F8] focus:bg-gray-200 transition duration-300 ease-in-out"
  >
    <svg
      width="20"
      height="20"
      ...
      className="mr-4 stroke-white group-hover:stroke-blue-600 transition duration-300"
      strokeWidth="2"
    >
      <path
    ...
    <span className="text-2xl font-medium hover:text-blue-600">Dashboard</span>
  </button>
</Link>
        <Link href="/">
  <button
  ...
  >
    ...
    <span className="text-2xl font-medium hover:text-blue-600">Rate Manager</span>
  </button>
</Link>
        <Link href="/">
  <button
    className="flex items-center pl-4 pr-5 py-2 rounded-lg mt-2 group hover:bg-[#F3F5F8] focus:bg-gray-200  ease-in-out"
  >
    <svg
      width="24"
      height="24"
    ...
    >
      ...
      />
      <circle cx="9" cy="11" r="0.7" fill="white" className="group-hover:fill-blue-600" />
      <circle cx="12" cy="11" r="0.7" fill="white" className="group-hover:fill-blue-600" />
      <circle cx="15" cy="11" r="0.7" fill="white" className="group-hover:fill-blue-600" />
    </svg>
    <span className="text-2xl font-medium group-hover:text-blue-600 ">All Messages</span>
  </button>
</Link>
      ...
      <button className="flex items-center pl-4 pr-12 py-2 mt-2 rounded-lg border border-transparent text-white transition duration-300 ease-in-out hover:bg-[#F3F5F8] hover:border-blue-600 hover:text-blue-600">
        ...
        >
          ...
          {/* Trend Line */}
          <path d="M6 18L10 12L14 16L20 10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          {/* Arrow at End */}
          <path d="M20 12V10H18" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>

  ...
  const updateWeightedAverages = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://api.tuma-app.com/api/treasury/apply-transaction-fees?baseCurrency=GBP&targetCurrency=KES&mpesaWeightedAverage=${mpesaWeightedAverage}&paybillWeightedAverage=${paybillWeightedAverage}&bankWeightedAverage=${bankWeightedAverage}`,
        {
          method: 'PUT',
          headers: {
